...
import Container,{CalendarContainer,CreditFormContainer} from './container'
...
let Routes = (
  <Router>
    ...
    <Route path="add" components={CreditFormContainer}/>
    <Route path="calendar" components={CalendarContainer}/>
    <Route path=":id" components={CreditFormContainer} />
