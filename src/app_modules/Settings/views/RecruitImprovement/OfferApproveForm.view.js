      ...
      <BaseForm onSubmit={onSubmit} ref={this.saveFormRef}>
        ...
        <FormItem>
          <Input
            ...
            rules={[{ max: 10, message: "最多输入10个字！" }, { validator: customRules.remote, value: '/sysSetOfferApproval/nameIsExistsJson', name: "name", defaultValue: item.name||"" }, { required: true, message: `不可为空`,  }, ]}
          />
        </FormItem>
