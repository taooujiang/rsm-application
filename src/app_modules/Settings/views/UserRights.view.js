            ...
            return (
              <ButtonGroups showSize="5" handleClick={this.handlerMenu.bind(this, row)}>
                ...
                {row.account == account ? null : ([
                  row.isEnable
                    ?
                    <Button icon="lock" actionkey="disabledAction" tooltext="禁用" confirm={[<p>已禁用帐号将无法登录系统。是否确定禁用该帐号？</p>, <p>温馨提示：请及时修改禁用成员的offer审批流程，避免影响招聘工作流程。</p>]} />
                    :
