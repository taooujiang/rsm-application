...
let initialState = {
 ...
 function saveNotices(state,payload){
    payload.list.forEach((it)=>state.notices.set(it[state.key],it))
    return state
}
...
function reducer(state = initialState, {type, payload}) {
  switch (type) {
    ...
    case CONSTANTS.SAVE_NOTICES:
      return saveNotices(state, payload)
