  ...
  render() {
    ...
    return (
      <BaseForm onSubmit={handleSubmit} ref={saveFormRef}>
        ...
        <FormItem {...formFullItemLayout}>
          <DatePicker label="预计转正日期" name="username" initialValue={username} />
        </FormItem>
        <FormItem {...formFullItemLayout}>
...
class EntryFormView extends FormPage{
  //请求远程数据接口
  componentWillMount() {
  ...
  render() {
    ...
    return (
      <Spin tip="Loading..." spinning={false}>
        <EntryForm onSubmit={this.onSubmit} initialValues={item} saveFormRef={this.saveFormRef}>
